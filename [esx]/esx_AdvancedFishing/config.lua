Config = {}
	...
	Config.FishPrice = {a = 200, b = 300} --Will get clean money THIS PRICE IS FOR EVERY 5 FISH ITEMS (5 kg)
	Config.TurtlePrice = {a = 1200, b = 1800} --Will get dirty money
	Config.SharkPrice = {a = 2000, b = 3000} --Will get dirty money
