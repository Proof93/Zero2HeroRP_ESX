...
Config.Items = {
    [1] = {label = "Ammobox",			item = "clip",				price = 200},
    [2] = {label = "Repair Kit",		item = "fixkit",			price = 400},
    [3] = {label = "Blowtorch",			item = "blowpipe",			price = 500},
    [4] = {label = "Bandage",			item = "bandage",			price = 100},
    [5] = {label = "Diving Mask",		item = "oxygen_mask",		price = 500},
    [6] = {label = "Bulletproof Vest",	item = "bulletproof",		price = 1500},
}
